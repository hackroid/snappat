...
public class RoundImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            borderWidth = array.getDimensionPixelOffset(R.styleable.RoundImageView_border_width, borderWidth);
            ...
            radius = array.getDimensionPixelOffset(R.styleable.RoundImageView_radius, radius);
