...
public class LoginPresenter extends BasePresent<LoginView> {
   ...
   * Get code .
   *
   * <p>Get code with phone number from server
   *
  ...
  public void regestry(String phone) {
    ...
    HttpUtils.postRequest(
        ...
        mContext,
        hashMap,
        new JsonCallback<CommonResponse<JSONObject>>() {
          @Override
   ...
   * Get codeAuthData .
   *
   * <p>Get codeAuthData with phone number and code from server
   *
   * @param mobilephone {@code String}
