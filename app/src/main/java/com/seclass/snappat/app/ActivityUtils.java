 ...
 *
 * <p>Activity switch will call the function in this class
 *
 * <p>Implement switch to next activity with some animation
 *
...
public class ActivityUtils {
  ...
  public static void next(
      Activity curActivity, Class<?> nextActivity, int inAnimId, int outAnimId) {
  ...
  public static void next(Activity curActivity, Class<?> nextActivity, Bundle extras) {
    next(
        curActivity, nextActivity, extras, -1, -1, R.anim.in_from_right, R.anim.out_to_left, false);
  }

  public static void next(
      Activity curActivity, Class<?> nextActivity, Bundle extras, Boolean isfinish) {
    next(
        curActivity,
        nextActivity,
        extras,
   ...
   */
  public static void next(
      Activity curActivity, Class<?> nextActivity, int flag, int inAnimId, int outAnimId) {
   ...
   */
  public static void next(
      Activity curActivity, Class<?> nextActivity, int inAnimId, int outAnimId, boolean isFinish) {
   ...
   */
  public static void next(
      Activity curActivity, Class<?> nextActivity, Bundle extras, int reqCode, boolean isFinish) {
    next(
        curActivity,
        nextActivity,
        extras,
   ...
   * @param isFinish 当前activity是否finish掉 {@code boolean} @Nullable extras @Nullable nextActivity
   */
  public static void next(
      Activity curActivity,
      Class<?> nextActivity,
   ...
   * @param outAnimId
   */
  public static void goBackWithResult(
      Activity curActivity, int retCode, Bundle retData, int inAnimId, int outAnimId) {
    Intent intent = null;
    intent = new Intent();
    if (null != retData) {
  ...
  public static void backActivityWithClearTop(Activity curActivity, Class<?> backActivity) {
    backActivityWithClearTop(
        curActivity, backActivity, null, R.anim.in_from_left, R.anim.out_to_right);
  }
   ...
   * @param extras
   */
  public static void backActivityWithClearTop(
      Activity curActivity, Class<?> backActivity, Bundle extras) {
    backActivityWithClearTop(
        curActivity, backActivity, extras, R.anim.in_from_left, R.anim.out_to_right);
  }
   ...
   */
  public static void backActivityWithClearTop(
      Activity curActivity, Class<?> backActivity, Bundle extras, int inAnimId, int outAnimId) {
