 ...
 *
 * 判断字符串是否为null或长度为0 isEmpty 判断字符串是否为null或全为空格 isSpace null转为长度为0的字符串 null2Length0 返回字符串长度 length
 * 首字母大写 upperFirstLetter 首字母小写 lowerFirstLetter 转化为半角字符 toDBC 转化为全角字符 toSBC
 */
