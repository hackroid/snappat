...
public class EasyUI {
  ...
  public static void setButtonOnClickListener(View view, int id, OnClickListener onClickListener) {
    ...
    if (!Button.class.isAssignableFrom(testView.getClass()) && !ImageButton.class
      .isAssignableFrom(testView.getClass())) {
  ...
  public static Method getMethod(Class<? extends Object> clazz, String methodName)
    throws Exception {
    Method method = null;
    try {
...
//    }
  ...
  public static ViewGroup.LayoutParams fillParentLayout = new ViewGroup.LayoutParams(
    ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT);
  public static LinearLayout.LayoutParams scaleHeightFillWidthLayout = new LinearLayout.LayoutParams(
    ViewGroup.LayoutParams.FILL_PARENT, 0, 1);
  public static LinearLayout.LayoutParams scaleWidthFillHeightLayout = new LinearLayout.LayoutParams(
