 ...
 *
 * 判断设备是否是手机 isPhone 获取手机的IMIE getPhoneIMEI 获取手机状态信息 getPhoneStatus 跳至填充好phoneNumber的拨号界面 dial
 * 拨打phoneNumber call 发送短信 sendSms 获取手机联系人 getAllContactInfo 打开手机联系人界面点击联系人后便获取该号码(注释萌萌哒)
 * getContantNum 获取手机短信并保存到xml中 getAllSMS
 */
public class PhoneUtils {
  ...
  public static void getAllSMS(Context context) {
    ...
    Cursor cursor = resolver
      .query(uri, new String[]{"address", "date", "type", "body"}, null, null, null);
    // 设置最大进度
